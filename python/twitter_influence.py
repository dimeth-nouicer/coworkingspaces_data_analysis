...
if __name__ == '__main__':
 ...
 followers_file1 = 'python/users/{}/followers.jsonl'.format(screen_name1)
 followers_file2 = 'python/users/{}/followers.jsonl'.format(screen_name2)
 ...
 try:
    con = psycopg2.connect("host='localhost' dbname='blog' user='postgres' password='123'")   
    cur = con.cursor()
    cur.execute("select ")
    cur.execute("insert into influence values(2,{},55,{},{},{},{},9)".format(followers1,sum_reach1,avg_followers1,sum(favorite_count1),sum(retweet_count1)))
    con.commit()
